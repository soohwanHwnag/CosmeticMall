...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    <link rel="stylesheet" href="/css/adminEventListContinue.css">
        ...
        <!-- 검색창 끝 -->
         ...
         <div class="eventCategory">
            <table>
                <tr>
                    <td class="event_btn" onclick="window.location.href='/event/list/continue'">진행중인 이벤트</td>
                    <td onclick="window.location.href='/event/list/finish'">종료된 이벤트</td>
                </tr>
            </table>
        </div>
        <!-- 이벤트 카테고리 끝 -->
        ...
        <!-- 버튼 끝 -->
         ...
         <div class="page">
            <c:if test="${nowpage != 1}">
              <span ><a href="/event/list/continue?page=${nowpage -1}}"><</a></span>
              </c:if>

...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %> 
    <link rel="stylesheet" href="/css/admin/adminEventJoin.css">
        ...
        <div class="eventMain">
        <div class="pageName">
            게시판 관리 > 이벤트 리스트 > 이벤트 등록
        </div>
        <!-- 이벤트 등록 폼 시작 -->
        <div class="formWarp">
            <form action="eventJoinForm" name="eventJoinForm" method="post" enctype="multipart/form-data" onsubmit="return clickEvent2();">
                <div class="eventDate">
                    <span>이벤트 기간</span>
                    <span>
                ...
                <div class="eventTitle">
                    <span>이벤트 제목</span>
                    <span>
                        <input type="text" name="event_title" id="" placeholder="제목을 입력하세요">
                    </span>
                </div>
                <div class="eventSlogan">
                    <span>이벤트 슬로건</span>
                    <span>
                        <input type="text" name="event_slogan" id="" placeholder="슬로건을 입력하세요">
                    </span>
                </div>
                <div class="eventFile">
                    <span>배너이미지</span> 
                        <input class="fileName" value="파일선택" disabled>
                        <label for="uploadfile"> 찾아보기</label>
                        <input type="file" name="event_banner_filename" class="uploadfile" id="uploadfile" >
                </div>
                <div class="eventFile">
                    <span>상세이미지</span> 
                        <input class="fileName2" value="파일선택" disabled>
                        <label for="uploadfile2"> 찾아보기</label>
                        <input type="file" name="event_detail_filename" class="uploadfile2" id="uploadfile2" >
                </div>
                <div class="button">
                    <div>
      ...
      <!-- 이벤트 등록 끝 -->
       ...
       function clickEvent2(){
        ...
        if(!document.eventJoinForm.event_detail_filename.value){
            alert("이벤트 배너이미지를 넣어주세요")
            return false;
           }
        if(!document.eventJoinForm.event_banner_filename.value){

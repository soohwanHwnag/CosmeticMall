...
<!-- CSS -->
<link rel="stylesheet" href="/css/faq_changeRefund.css">
  ...
  function display(){
	if($(".subcontent").css("display")=="none"){
		...
		$(".subcontent").show();
		$(".subtitle td:nth-of-type(3)").css({'background':'url("./up-arrow.png")no-repeat'});
        $(".subtitle td:nth-of-type(3)").css({'background-position':'1px'});
	} else {
		$(".subcontent").hide();
$(".subtitle td:nth-of-type(3)").css({'background':'url("./down-arrow.png")no-repeat'});
$(".subtitle td:nth-of-type(3)").css({'background-position':'1px'});
	}
}
</script>
   ...
   <div class="container faqMain">
        ...
        <table>
            ...
            <tr class="subtitle${list.faq_idx}" onclick="display(${list.faq_idx});">
